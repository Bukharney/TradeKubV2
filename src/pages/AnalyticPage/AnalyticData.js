...
const Most_Volume_Sum_by_Company = [
  {
    ...
    Volume_Sum: 500,
    Avg_Price: 40,
    total_buying_orders: 200,
    total_selling_orders: 200,
  },
  {
    Company: "A",
    Volume_Sum: 500,
...
const Most_Volume_Sum_by_Company_Columns = Object.keys(
  Most_Volume_Sum_by_Company[0]
);
const Most_New_Contract_by_Broker_Company_Columns = Object.keys(
  Most_New_Contract_by_Broker_Company[0]
);
const Most_Close_Stock_Value_By_Date_Columns = Object.keys(
  Most_Close_Stock_Value_By_Date[0]
);
...
const Most_Volume_Sum_by_Company_Rows = Most_Volume_Sum_by_Company.map(
  (document) => Object.values(document)
);
const Most_New_Contract_by_Broker_Company_Rows =
  Most_New_Contract_by_Broker_Company.map((document) =>
    Object.values(document)
  );
const Most_Close_Stock_Value_By_Date_Rows = Most_Close_Stock_Value_By_Date.map(
  (document) => Object.values(document)
);
